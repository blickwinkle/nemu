...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, csrrw(&s->dnpc, NULL, CSR_MEPC); cpu.mstatus.mie = cpu.mstatus.mpie; cpu.mstatus.mpie = 1; IFDEF(CONFIG_ITRACE_FUNC, ret_ftrace(s->pc, s->dnpc)));
  // B type
